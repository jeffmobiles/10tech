...
export default class Home extends React.Component {
  ...
  render() {
    const children = [
      ...
      <Content7 id="content_9_0" key="content_9_0" isMode={this.state.isMode}/>,
      <Content8 id="content_10_0" key="content_10_0" isMode={this.state.isMode}/>,
      <Content9 id="content_1_0" key="content_1_0" isMode={this.state.isMode}/>,
